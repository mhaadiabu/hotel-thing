  ...
  return (
    <main id="main-content" className="min-h-[100dvh] bg-background">
      ...
      <section className="relative min-h-[calc(100svh-4.5rem)] overflow-hidden">
        <Image
          src={HOTEL_IMAGE}
          alt="Haven Hotel exterior at dusk"
          fill
          priority
          unoptimized
          sizes="100vw"
        ...
        <div className="relative mx-auto flex min-h-[calc(100svh-4.5rem)] max-w-7xl items-end px-4 pb-16 pt-24 sm:px-6 sm:pb-20 lg:px-8">
          <div className="max-w-3xl text-white">
            ...
            <h1 className="mt-4 text-balance font-heading text-4xl font-semibold leading-tight sm:text-7xl">
              Haven Hotel
            </h1>
            <p className="mt-5 max-w-xl text-pretty text-base leading-7 text-white/85 sm:text-lg">
              Comfortable rooms, attentive service, and a straightforward stay from booking to
              check-out.
            </p>
            <Button
      ...
      <section className="border-b py-16 sm:py-20">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[1fr_1.4fr] lg:px-8">
          <div>
            <p className="text-xs font-medium uppercase text-muted-foreground">Your stay</p>
            <h2 className="mt-3 text-balance font-heading text-3xl font-semibold sm:text-4xl">
              Everything you need, without the friction.
            </h2>
          </div>
          <div className="grid gap-6 sm:grid-cols-3">
            <div>
              <HugeiconsIcon icon={BedIcon} />
              <h3 className="mt-4 font-medium">Rest well</h3>
              <p className="mt-2 text-sm leading-6 text-muted-foreground">
                Thoughtful rooms with practical details for short visits and longer stays.
              </p>
            </div>
            <div>
              <HugeiconsIcon icon={Wifi01Icon} />
              <h3 className="mt-4 font-medium">Stay connected</h3>
              <p className="mt-2 text-sm leading-6 text-muted-foreground">
                Reliable Wi-Fi and simple self-service access to your booking.
              </p>
            </div>
            <div>
              <HugeiconsIcon icon={Coffee02Icon} />
              <h3 className="mt-4 font-medium">Ask anytime</h3>
              <p className="mt-2 text-sm leading-6 text-muted-foreground">
                Booked guests can request housekeeping, amenities, or maintenance from their
                dashboard.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="mx-auto flex max-w-7xl flex-col gap-6 px-4 sm:flex-row sm:items-end sm:justify-between sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            <p className="text-xs font-medium uppercase text-muted-foreground">Book direct</p>
            <h2 className="mt-3 text-balance font-heading text-3xl font-semibold">
              Choose a room that fits the way you travel.
            </h2>
            <p className="mt-4 text-pretty leading-7 text-muted-foreground">
              See current availability, room details, rates, and photography before you reserve.
            </p>
          </div>
          <Button
