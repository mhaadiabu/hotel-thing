  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed top-1/2 left-1/2 z-50 grid max-h-[calc(100svh-2rem)] w-full max-w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 gap-5 overflow-y-auto rounded-xl bg-popover p-6 text-sm text-popover-foreground shadow-xl ring-1 ring-foreground/5 outline-none sm:max-w-lg ease-[var(--ease-smooth-out)] data-open:duration-[var(--duration-fast)] data-closed:duration-[var(--duration-quick)] data-open:animate-in data-open:fade-in-0 data-open:[--tw-enter-scale:var(--scale-large)] data-closed:animate-out data-closed:fade-out-0 data-closed:[--tw-exit-scale:var(--scale-large)]",
          className
        )}
        {...props}
      >
